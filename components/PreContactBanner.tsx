...
export default function PreContactBanner() {
  const words = ["Precision", "Reliability", "Excellence", "Quality"];
  ...
  return (
    <section className="h-[20rem] flex justify-center items-center px-4 bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800">
      <div className="text-2xl sm:text-3xl md:text-5xl mx-auto font-normal text-slate-600 dark:text-slate-400 text-center">
        We deliver <br />
        <FlipWords
          words={words}
          duration={1500}
